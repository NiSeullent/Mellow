...
void Genx::init() {
	callback = this;
	// Retain shared helper callbacks used by Gen11, but do not register the
	// legacy ICL framebuffer in this Ultra-only plugin.
}
...
bool Genx::processKext(KernelPatcher &patcher, size_t index, mach_vm_address_t address, size_t size) {
    ...
    if (kextG11FB0.loadIndex == index) {
		...
		SolveRequestPlus solveRequests[] = {
			...
			/*{"__ZN15ApppeIntelPlane10gMetaClassE", MellowCore::callback->metaClassMap[0][0]},
			{"__ZN16ApppeIntelScaler10gMetaClassE", MellowCore::callback->metaClassMap[1][0]},
			{"__ZN21ApppeIntelDisplayPath10gMetaClassE", MellowCore::callback->metaClassMap[2][0]},
			{"__ZN30ApppeIntelDisplaySimController10gMetaClassE", MellowCore::callback->metaClassMap[3][0]},*/
			
			/*{"__ZN14ApppeIntelPort10gMetaClassE", MellowCore::callback->metaClassMap[0][1]},
			{"__ZN17ApppeIntelPortHAL10gMetaClassE", MellowCore::callback->metaClassMap[1][1]},
			{"__ZN22ApppeIntelPortHALDiags10gMetaClassE", MellowCore::callback->metaClassMap[2][1]},
			{"__ZN19ApppeIntelPowerWell10gMetaClassE", MellowCore::callback->metaClassMap[3][1]},*/
		...
		PANIC_COND(!SolveRequestPlus::solveAll(patcher, index, solveRequests, address, size), "mellow",	"genx Failed to resolve symbols");
		...
		PANIC_COND(!RouteRequestPlus::routeAll(patcher, index, requests, address, size), "mellow","genx Failed to route symbols");
